 ...
 */
 ...
 class Knime {
    ...
    def public assemble() {
    	...
    	if (this.utoken) {string +=  "-workflow.variable=input_url_token,${this.utoken},String " }
    	if (this.uifile) {string +=  "-workflow.variable=input_url_insert_file,${this.uifile},String " }
    	if (this.uidata) {string +=  "-workflow.variable=input_url_insert_data,${this.uidata},String " }
